...
export function VictoryScreen() {
  ...
  return (
    <div style={{
      ...
      background: 'radial-gradient(ellipse at center, #0a1f0a 0%, #0a0e0a 70%)', color: '#fff', fontFamily: 'monospace',
    }}>
      <h1 style={{ fontSize: 'clamp(2rem, 5vw, 3.5rem)', color: '#4ade80', textShadow: '0 0 40px rgba(74,222,128,0.6)', marginBottom: 8, textAlign: 'center' }}>
        🎉 DIAMOND HANDS! 🎉
      </h1>
